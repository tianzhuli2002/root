...
void RooStats::HistFactory::Measurement::AddPreprocessFunctionCallback( PreprocessFunctionCallback callback )
{
  if (callback) {
...
void RooStats::HistFactory::Measurement::ApplyPreprocessFunctionCallbacks( RooWorkspace& ws ) const
{
